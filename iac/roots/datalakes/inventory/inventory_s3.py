...
args = getResolvedOptions(sys.argv, ['JOB_NAME', 'SOURCE_DATABASE_NAME', 'SOURCE_TABLE_NAME', 'NAMESPACE', 'TABLE_BUCKET_ARN'])
...
AWSGlueDataCatalog_node1738074158972_df.createOrReplaceTempView("temp_inventory")
